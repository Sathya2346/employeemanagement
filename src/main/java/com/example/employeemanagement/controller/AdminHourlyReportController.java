...
public class AdminHourlyReportController {
    ...
    @GetMapping("/hourlyReports/download/{id}")
    @ResponseBody
    public void downloadReportPdf(@PathVariable Long id, HttpServletResponse response) throws Exception {
        hourlyReportService.exportReportAsPdf(id, response);
    }
