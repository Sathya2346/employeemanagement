...
filterForm.addEventListener('submit', (e) => {
    ...
    employeeCards.forEach(card => {
        ...
        const empDeptElem = card.querySelector('.departmentForFilter');
        const empDept = empDeptElem ? empDeptElem.innerText.trim().toLowerCase() : '';

        const matchesName = !nameVal || empName.includes(nameVal);
        const matchesId = !idVal || empId === idVal;
        const matchesDept = !deptVal || empDept === deptVal.toLowerCase();
